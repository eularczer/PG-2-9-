...
% But we need to pay atteion to the structure of PG(2,9),since the 3 points
% on a line can be not isomorphic. They can in a PG(1,3) subplane or not !!!
...
% Maybe in PG(3,9), we can directly remove two nonintersecting lines, with
